...
This document provides comprehensive documentation for the Apache Kafka event streaming system in the Money Flow application.

---

## Overview

The Money Flow application uses Apache Kafka for event-driven architecture. Unlike RabbitMQ (task queue), Kafka provides an immutable event log with multiple consumers.
...
# Consumer
KAFKA_GROUP_ID=money-flow-main
...
pub static KAFKA: Lazy<KafkaConfig> = Lazy::new(|| {
    ...
    KafkaConfig {
        ...
        group_id: std::env::var("KAFKA_GROUP_ID")
            .unwrap_or_else(|_| "money-flow-main".to_string()),
