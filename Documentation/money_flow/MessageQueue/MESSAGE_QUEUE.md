...
This document provides comprehensive documentation for the RabbitMQ message queue system in the Money Flow application.

---

## Overview

The Money Flow application uses RabbitMQ for asynchronous task processing. It's designed for reliable, background job execution with priority support and automatic retries.
