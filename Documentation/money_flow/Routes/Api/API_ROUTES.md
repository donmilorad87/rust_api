...
This document provides comprehensive documentation for all REST API routes in the Money Flow application.

---

## Overview

API routes return JSON responses and are defined in `money_flow/src/routes/api.rs`. They follow RESTful conventions and use JWT authentication for protected endpoints.
