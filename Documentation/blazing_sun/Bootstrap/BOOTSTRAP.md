...
This document provides comprehensive documentation for the Bootstrap module - the core framework layer of the Blazing Sun application.

**File Location:** `blazing_sun/src/bootstrap/`

---

## Overview

The Bootstrap module contains the core system components that power the Blazing Sun application. It provides:
...
|----------|---------|---------|
| `Welcome` | Welcome to Blazing Sun! | Welcome new user |
