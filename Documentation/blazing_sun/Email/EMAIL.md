...
This document provides comprehensive documentation for the email system in the Blazing Sun application.

---

## Overview

The Blazing Sun application uses a robust email system built on:
...
pub static EMAIL: Lazy<EmailConfig> = Lazy::new(|| {
    ...
    EmailConfig {
        ...
        from_address: std::env::var("MAIL_FROM_ADDRESS")
            .unwrap_or_else(|_| "noreply@blazingsun.app".to_string()),
        from_name: std::env::var("MAIL_FROM_NAME")
            .unwrap_or_else(|_| "Blazing Sun".to_string()),
...
|----------|------|---------|-----------|
| Welcome | `welcome.html` | "Welcome to Blazing Sun!" | `first_name`, `email` |
| Account Activation | `account_activation.html` | "Activate Your Blazing Sun Account" | `first_name`, `email`, `activation_code` |
...
impl EmailTemplate {
    ...
    pub fn subject(&self) -> &'static str {
        match self {
            EmailTemplate::Welcome => "Welcome to Blazing Sun!",
            EmailTemplate::AccountActivation => "Activate Your Blazing Sun Account",
...
<p>Thank you for registering with Blazing Sun. To activate your account, please use the following code:</p>
...
| `app_name` | Application name | "Blazing Sun" |
