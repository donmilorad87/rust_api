...
This document provides comprehensive documentation for the file upload system in the Blazing Sun application, including storage drivers, visibility levels, and upload operations.
...
impl S3StorageDriver {
    ...
    fn public_url(&self, key: &str) -> String {
        ...
        // If custom endpoint (MinIO, DO Spaces), use endpoint URL
            ...
            // Result: "https://minio.example.com/blazing-sun-uploads/public/20240115_123456_uuid.jpg"
        }
        // Default: AWS S3 URL
        else {
            format!(
            ...
            // Result: "https://blazing-sun-uploads.s3.us-east-1.amazonaws.com/public/20240115_123456_uuid.jpg"
        }
    }
}
```
...
AWS_REGION=us-east-1
AWS_BUCKET=blazing-sun-uploads
```
