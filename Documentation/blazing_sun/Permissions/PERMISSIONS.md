...
This document provides comprehensive documentation for the permission-based access control system in the Blazing Sun application.
...
**File Location:** `blazing_sun/src/bootstrap/middleware/controllers/permission.rs`
